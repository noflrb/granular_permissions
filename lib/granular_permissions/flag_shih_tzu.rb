...
module GranularPermissions
  ...
  # The following is an exact copy of FlagShihTzu by xing to get
  # this functionality independent from GranularPermissions
  # got to http://github.com/xing/flag_shih_tzu
  module FlagShihTzu
